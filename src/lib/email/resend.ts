...
import { COMPANY_ADDRESS_HTML, COMPANY_ADDRESS_USA } from '@/lib/company-address';
    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>TGA Tour and Travel LLC (Marefat Pilgrimage)<br>
            ${COMPANY_ADDRESS_HTML}<br>
            Premium Umrah, Hajj &amp; Ziyarat Tours<br>
            <a href="mailto:info@marefatpilgrimage.com" style="color:#666;">info@marefatpilgrimage.com</a></p>
          </div>
        </div>
      </body>
      </html>
...
export async function sendBookingConfirmationEmail({
  ...
  const wireDetailsHtml = `
    <div style="background:#fff; border:1px solid #e5dcc8; border-radius:10px; padding:20px; margin:20px 0;">
      ...
      <table style="width:100%; border-collapse:collapse; font-size:14px; color:#151515;">
        <tr><td style="padding:5px 0; width:160px; color:#777; font-weight:500;">Registered address</td><td style="padding:5px 0;">${COMPANY_ADDRESS_USA}</td></tr>
  ...
  const zelleDetailsHtml = `
    <div style="background:#fff; border:1px solid #e5dcc8; border-radius:10px; padding:20px; margin:20px 0;">
      ...
      <table style="width:100%; border-collapse:collapse; font-size:14px; color:#151515;">
        <tr><td style="padding:5px 0; color:#777; font-weight:500;">Registered address</td><td style="padding:5px 0;">${COMPANY_ADDRESS_USA}</td></tr>
    ...
    html: `
      ...
      <body style="font-family: system-ui, sans-serif; color: #151515;">
        <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          <p style="margin-top: 24px; font-size: 11px; color: #999; line-height: 1.55;">TGA Tour and Travel LLC<br>${COMPANY_ADDRESS_HTML}</p>
        </div>
      </body>
      </html>
    `,
    ...
    html: `
      ...
      <body style="font-family:system-ui,sans-serif; color:#151515; margin:0; padding:0; background:#f5f5f5;">
        <div style="max-width:600px; margin:0 auto; padding:40px 20px;">
          ...
          <div style="margin-top:24px; text-align:center; font-size:12px; color:#999; line-height:1.55;">
            Marefat Pilgrimage — Internal Notification<br>
            <span style="font-size:11px; color:#aaa;">TGA Tour and Travel LLC<br>${COMPANY_ADDRESS_HTML}</span>
          </div>
        </div>
      </body>
      </html>
