...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className={`fixed z-50 flex items-center justify-center rounded-full bg-[#25D366] p-3.5 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-[#20bd5a] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 ${
        isVisible
